...
export default function LibraryAuth() {
  const { auth, user, userProfile, loading, signInWithGoogle } = useAuth();
  ...
  return (
    ...
    >
      ...
      >
        <div className="p-8 bg-white/10 backdrop-blur-xl border border-white/20 rounded-[30px] shadow-2xl text-white">
