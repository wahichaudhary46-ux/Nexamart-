...
export default function AccountPage() {
  ...
  const AccountItem = ({ icon: Icon, label, href = "#" }: { icon: any, label: string, href?: string }) => (
    <Link href={href} className="flex items-center justify-between py-4 group active:bg-gray-50 transition-colors">
  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-24 font-body">
      {/* Header */}
      <div className="bg-white border-b border-gray-100 sticky top-0 z-50 px-4 h-14 flex items-center">
      ...
      <main className="max-w-md mx-auto">
        ...
        <section className="bg-white p-6 mb-2">
          <div className="flex items-center gap-4">
            <Avatar className="h-16 w-16 border-2 border-gray-50 shadow-sm">
        ...
        <section className="bg-white px-4 mb-2">
          <h3 className="text-[11px] font-black text-gray-400 uppercase tracking-widest pt-4 pb-2">Account Settings</h3>
        ...
        <section className="bg-white px-4 mb-2">
          <h3 className="text-[11px] font-black text-gray-400 uppercase tracking-widest pt-4 pb-2">My Activity</h3>
          <div className="flex flex-col">
        ...
        <section className="bg-white px-4 mb-2">
          <h3 className="text-[11px] font-black text-gray-400 uppercase tracking-widest pt-4 pb-2">Business</h3>
          <Link href="/dashboard" className="flex items-center justify-between py-5 px-4 bg-primary/5 rounded-2xl border border-primary/10 mt-2 mb-4 group active:scale-[0.98] transition-all">
            <div className="flex items-center gap-4">
              ...
              <div className="flex flex-col">
                <span className="text-sm font-black text-gray-900">Register Your Shop</span>
                <span className="text-[11px] text-gray-500 font-bold uppercase tracking-tight">Partner with us today</span>
              </div>
            </div>
        ...
        <section className="bg-white px-4 mb-2">
          <h3 className="text-[11px] font-black text-gray-400 uppercase tracking-widest pt-4 pb-2">Feedback & Information</h3>
          <div className="flex flex-col">
        ...
        <div className="px-4 mt-6">
          <Button 
            ...
            variant="outline" 
            className="w-full h-12 bg-white border-gray-200 text-primary font-black rounded-xl shadow-sm active:bg-gray-50 transition-colors uppercase tracking-widest text-xs"
          >
            <LogOut className="w-4 h-4 mr-2" />
            Log Out
          </Button>
          <p className="text-center text-[10px] text-gray-300 font-bold mt-8 uppercase tracking-[0.2em]">
            NexaMart v1.0.4
          </p>
        </div>
      </main>
      ...
      <nav className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-100 flex items-center justify-around h-20 z-50 px-2 pb-2 shadow-[0_-4px_20px_rgba(0,0,0,0.03)]">
